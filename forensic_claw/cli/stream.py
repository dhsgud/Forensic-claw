...
from forensic_claw import __logo__
...
class ThinkingSpinner:
    """Spinner that shows 'forensic-claw is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]forensic-claw is thinking...[/dim]", spinner="dots")
        self._active = False
