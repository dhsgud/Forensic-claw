...
try {
    ...
    [void] $builder.AppendLine('        <Shortcut Id="InfraManagerShortcut" Name="Forensic-Claw Infra Manager" Description="Prepare Docker, native, or external storage infrastructure" Target="[INSTALLFOLDER]Forensic-Claw.exe" Arguments="infra init" WorkingDirectory="INSTALLFOLDER" />')
