...
from forensic_claw.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from forensic_claw.agent.tools.registry import ToolRegistry
from forensic_claw.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("forensic_claw.agent.tools.mcp.logger.warning", _warning)
